...
class Find extends Component {
    ...
    render(){
        return (
            ...
            <Container className="search-container bg-light shadow-lg">
                <h4>Book Search</h4>
                <Form>
                    <Form.Group>
            ...
            <Container className="results bg-light shadow-lg">
            <h3 id="result">Results:</h3>
            <div>
                {this.state.books.map(book => (
                <div className="media-div">
                    <Media key={book.title}>
                        <Media.Body className="bg-light">
                        ...
                        <Button variant="info" href={book.volumeInfo.previewLink}>View</Button>
                        <Button variant="success ml-2" type="submit" onClick={this.saveButtonSubmit} name={book.volumeInfo.description} value={[book.volumeInfo.title,book.volumeInfo.imageLinks.thumbnail,book.volumeInfo.authors[0],book.volumeInfo.previewLink]}>Save</Button>
                    </Media>
                </div>
